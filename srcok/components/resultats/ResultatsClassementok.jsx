  ...
  return (
    <section className="resultats-section">
      <h2 className="section-title">
        🏆 Classement officiel - Tour {tour}
      </h2>

      <div className="classement-meta">
        <div>
          <strong>Total des suffrages exprimés :</strong> {totalExprimes.toLocaleString('fr-FR')}
        </div>
        <div>
          <strong>Qualification :</strong> les 2 premiers sont qualifiés pour le 2nd tour
        </div>
      </div>
